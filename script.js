document.addEventListener('DOMContentLoaded', () => {
  ...
  const setupPremiumFooter = () => {
    ...
    const isMockHubPage = window.location.pathname.endsWith('/mock-test.html') || window.location.pathname.endsWith('mock-test.html');
    ...
    const examLinkHeading = isMockHubPage ? 'Mock Test Categories' : isRajasthanPage ? 'Rajasthan Exam Links' : isCentralPage ? 'Central Exam Links' : isCivilPage ? 'Civil Services Links' : isNursingPage ? 'Nursing Exam Links' : isSchoolPage ? 'School Class Links' : isOtherStatePage ? 'Other State Exam Links' : isAgriculturePage ? 'Agriculture Exam Links' : isCollegeEntrancePage ? 'College Entrance Links' : isMiscPage ? 'Misc Exam Links' : 'Teaching Exam Links';
    const examLinks = isMockHubPage
      ? [
        ...
        { href: `${footerBasePath}mock-test/civil-services-exams.html`, label: 'Civil Services Exams' },
        { href: `${footerBasePath}mock-test/nursing-exams.html`, label: 'Nursing Exams' },
        { href: `${footerBasePath}mock-test/school-test.html`, label: 'School Test' },
        { href: `${footerBasePath}mock-test/other-state-govt-exams.html`, label: 'Other State Govt Exams' },
        { href: `${footerBasePath}mock-test/agriculture-exams.html`, label: 'Agriculture Exams' },
        { href: `${footerBasePath}mock-test/college-entrance-exams.html`, label: 'College Entrance Exams' },
        { href: `${footerBasePath}mock-test/miscellaneous-exams.html`, label: 'Miscellaneous Exams' }
      ]
      : isRajasthanPage
      ? [
      ...
      : [
        { href: `${footerBasePath}mock-test.html`, label: 'Mock Test Hub' },
